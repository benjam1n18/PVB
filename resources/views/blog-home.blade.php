            ...
            <div class="single-page-collumn col-lg-9">
               ...
               <div class="blog-post">
                  ...
                  <div class="col-md-12">
                     <!-- Post header -->
                     <h3>
                        <a href="blog-post.blade.php">High Quality Daycare</a>
                     </h3>
                     <div class="post-info">
                        <!-- Post Author -->
                     ...
                     <a class="btn" href="blog-post.blade.php">Read More <i class="fa fa-angle-right"></i></a>
                  </div>
               </div>
               <!-- /.row -->
               <!-- Blog Post -->
               <div class="blog-post">
                  ...
                  <div class="col-md-12">
                     <!-- Post header -->
                     <h3>
                        <a href="blog-post.blade.php">Parents Meeting</a>
                     </h3>
                     <div class="post-info">
                        <!-- Post Author -->
               ...
               <div class="blog-post">
                  ...
                  <div class="col-md-12">
                     <!-- Post header -->
                     <h3>
                        <a href="blog-post.blade.php">Free Activities this week</a>
                     </h3>
                     <div class="post-info">
                        <!-- Post Author -->
                        <p><i class="fa fa-user"></i>by <a href="#">Mary Jane</a></p>
