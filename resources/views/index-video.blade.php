...
<html lang="en">
   ...
   <body id="page-top" class="full" data-bs-spy="scroll" data-bs-target=".navbar-nav" >
      ...
      <!--/navbar ends-->
      <!-- Video header -->
      <div id="video-header" class="ratio ratio ratio-4x3">
         <!-- placeholder image in case the browser doesn't play the video -->
         <video id="bgvid" class="bottom-0 h-auto" playsinline autoplay muted loop>
            <!-- video -->
            <source src="videos/video1.mp4" type="video/mp4">
         </video>
         <div class="container-fluid video">
            <div class="col-lg-4 offset-lg-1 col-sm-12 d-flex aligns-items-center h-100">
               <div class="video-text my-auto">
                  <h1>Welcome to Alphabet</h1>
                  <p class="lead hidden-xs hidden-sm">Alphabet Daycare will provide a stimulating and safe environment for children ages three months to ten years.
                  </p>
                  <div class="page-scroll">
                     <!-- Button-->
                     <a class="btn hidden-xs hidden-sm" href="#contact">Contact us</a>
                  </div>
                  <!-- /page-scroll -->
               </div>
               <!-- /video-text -->
            ...
            <div class="row align-items-center">
               ...
               <div class="col-lg-7 col-sm-12">
                  ...
                  <p>Ibu lum orci eget, viverra elit. Aliquam erat volut pat phas ellus ac
                     Placerat a ultricies a, posuere lorem ipseut lincas psuiem t volut pat phas ellus ac sodales Lorem ipsum dolor sit amet, consectetur adipisicing elit uasi quidem minus id omnis a nibh fusce mollis.
                  </p>
                  <p>Interdum donec eget metus auguen unc vel lorem ispuet Ibu lum orci eget, viverra elit liquam erat volut pat phas ellus ac sodales Lorem ipsum dolor sit amet, consectetur adipisicing elit uasi quidem minus id omnis.
                  </p>
                  <p>
         ...
         <div class="container">
            ...
            <div class="row team align-items-center">
               ...
               <div class="col-lg-6 p-2 ps-xl-5">
                  ...
                  <p>Placerat a ultricies a, posuere a nibh fusce mollis imperdie tlorem ipuset campas fincas interdum donec eget metus auguen unc vel mauris ultricies.
                  </p>
               </div>
               <!-- /col-lg -->
            </div>
      ...
      <section id="activities">
         <div class="container">
            ...
            <ul class="nav nav-tabs justify-content-center" id="pills-tab" role="tablist">
               ...
               <!--/nav-item -->
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-2-tab" data-bs-toggle="pill" data-bs-target="#pills-2" type="button" role="tab"  aria-selected="false">Spanish</button>
               </li>
               <!--/nav-item -->
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-3-tab" data-bs-toggle="pill" data-bs-target="#pills-3" type="button" role="tab" aria-selected="false">Lunch</button>
               </li>
               <!--/nav-item -->
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-4-tab" data-bs-toggle="pill" data-bs-target="#pills-4" type="button" role="tab" aria-selected="false">Swimming</button>
               </li>
               <!--/nav-item -->
               <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-5-tab" data-bs-toggle="pill" data-bs-target="#pills-5" type="button" role="tab" aria-selected="false">Playground</button>
               </li>
               <!--/nav-item -->
            </ul>
            <!--/nav-tabs -->
