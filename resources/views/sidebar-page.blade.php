...
<div class="blog jumbotron">
    <div class="container">
        <div class="col-lg-6 col-centered text-center">
            <h1 class="text-light">Sidebar page</h1>
            <!-- Breadcrumb -->
...
<!-- /jumbotron -->
<!-- Clouds SVG Divider -->
<svg id="deco-clouds2" class="head d-none d-md-block" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%"
...
<div id="page" class="container">
    <div class="row">
        ...
        <div class="single-page-collumn col-lg-9">
            ...
            <p class="fw-bold">Ibu lum orci eget, viverra elit aliquam erat volut pat phas ellus ac sodales felis tiam
                non Doloreiur qui commolu ptatemp dolupta orem retibusam andigen Ibu lum orci eget
            <p>Viverra elit aliquam erat volut pat phas ellus ac sodales commolu ptatemp dolupta orem reti felis tiam
                non metus. Placerat a ultricies a, posuere lorem ipseut lincas psuiem t volut pat phas ellus ac
                sodales. </p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit uasi quidem minus id omnis a nibh fusce mollis
                imperdie tlorem ipuset campas fincas interdum donec eget metus auguen unc vel mauris ultricies,
            </p>
            <!-- row -->
            <div class="row mt-2 g-lg-5">
                <div class="col-xl-5 text-center">
                    <!-- image -->
                    <img src="img/service2.jpg" alt="" class="rounded img-fluid">
                </div>
                <!-- /col-xl -->
                <div class="col-xl-7 mt-5">
                    <h4>Parents meeting</h4>
                    <p class="res-margin">Ibu lum orci eget, viverra elit. Aliquam erat volut pat phas ellus ac sodales
                        felis tiam non Doloreiur qui commolu ptatemp dolupta orem retibusam andigen Ibu lum orci eget,
                        viverra elit aliquam erat volut pat phas ellus ac sodales felis tiam non metus.</p>
                    <p>Phas ellus ac sodales Lorem ipsum dolor sit amet, consectetur adipisicing elit uasi quidem minus
                        id omnis a nibh fusce mollis imperdie tlorem ipuset campas fincas interdum donec</p>
                    <p>Eget metus auguen unc vel mauris ultricies, Placerat a ultricies a, posuere lorem ipseut lincas
                        psuiem t volut pat.
                    </p>
                </div>
                <!-- /col-xl -->
            ...
            <div class="row mt-5">
                <div class="color_block">
                    ...
                    <p>Doloreiur qui lorem commolu ptatemp dolupta orem retibusam andigen Ibu lum orci eget, viverra
                        elit aliquam erat volut pat phas ellus ac sodales felis tiam non metus. Placerat a ultricies a,
                        posuere lorem ipseut lincas psuiem t volut pat phas ellus ac sodales Lorem ipsum dolor sit
                        amet</p>
                    <!-- Button-->
        ...
        <!-- /single-page-collumn -->
        <!-- Sidebar -->
        <div class="sidebar col-lg-3 p-4">
            <!-- Categories -->
            <div class="card">
                <h5>Categories</h5>
                <div class="row">
            ...
            <div class="card">
                <h5>About Us</h5>
                <p>Laudantium odit aliquam repellat Doloreiur qui commolu ptatemp dolupta ore tempore quos
                    aspernatur.</p>
                <!-- Social Media icons -->
